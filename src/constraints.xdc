...
set_property -dict { PACKAGE_PIN D22 IOSTANDARD LVCMOS12 } [get_ports { buttons[0] }]; #IO_L22N_T3_16 Sch=btnd

set_property -dict { PACKAGE_PIN C22 IOSTANDARD LVCMOS12 } [get_ports { buttons[3] }]; #IO_L20P_T3_16 Sch=btnl
